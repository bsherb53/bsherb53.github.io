...
app.controller('myCtrl', function($scope) {
    ...
    var biomes = ["Ocean", "Forest", "Desert", "Plain", "Jungle", "Mountain"];
    var types = ["Abberation", "Beast", "Construct", "Dragon", "Elemental", "Monstrosity", "Ooze", "Plant", "Undead"];
    var ratings = ["0", "1/8", "1/4", "1/2", "1", "2"];
    var weathers = ["rainy", "sunny", "cloudy", "hot"];
    var owners = ["Ginger", "Dusk", "Kiroth", "DragonQueen"];
